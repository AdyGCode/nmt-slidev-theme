...
<div @click="$slidev.nav.next" class="mt-12 p-1 bg-white/10" hover:bg="white op-10">
  Press Space for next page <fa7-solid-arrow-right />
</div>
...
<div class="abs-br m-6 text-xl">
  ...
  <a href="https://github.com/slidevjs/slidev" target="_blank" class="slidev-icon-btn">
    <fa7-brands-github></fa7-brands-github>
  </a>
</div>
